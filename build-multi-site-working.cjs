...
class WorkingBuilder {
  ...
  buildAll() {
    ...
    this.copyDirectory(path.join(this.projectRoot, 'public'), path.join(this.distDir, 'public'));
    this.log('✓ Copied public directory');
    
    this.copyDirectory(path.join(this.projectRoot, 'static'), path.join(this.distDir, 'static'));
