...
export class SchwelevisionSystem {
  ...
  /**
   * Add viewer to current broadcast
   */
  addViewer() {
    return this.state.addViewer();
  }

  /**
   * Remove viewer from current broadcast
   */
  removeViewer() {
    return this.state.removeViewer();
  }
}
